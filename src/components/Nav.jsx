...
function Nav() {
  return (
    <>
      <nav class="flex justify-center w-full fixed z-100 bg-[#151515]">
        <div class="max-w-[1600px] w-full flex justify-between items-center text-white font-light m-3">
          <div class="flex justify-center items-center space-x-8 ">
            <A href="/#" class="hover:opacity-[0.8] transition-all duration-200">
            ...
            <div class="nav__item relative bg-[#151515]">
              ...
              translate-y-[-20px] opacity-0 text-black space-y-2 p-3 pt-6 nav__drop flex-col z-1 transition-all duration-300 invisible bg-[#151515] z-99"
              >
